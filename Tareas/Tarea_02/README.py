...
#XPLICACIÓN: numero_1 es la primera variable a ingresar, que corresponde a un tipo de dato de ingreso de información (input), en este caso, tu edad, la cual solo podrá corresponder a números naturales (int). Numero_2 la segunda variable la cual solo puede adquirir el valor de 5. Suma corresponde a la variable definida por la operación de suma de las anteriores, y, resultado es la suma realizada de numero_1 y numero_2 textualmente ("").
